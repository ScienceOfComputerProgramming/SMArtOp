...
/**
 * This class defines the PARALLEL_FACTOR based on the mode sparseness of the rows and the number of physical cores.
 * @author Antonela Tommasel
 *
 */
public class TaskSplitPolicyMode extends TaskSplitPolicyRowSparseness{

	/**
	 * Defines alpha as 1- mode_sparseness.
	 * @param left
	 * @return alpha
	 */
	@Override
